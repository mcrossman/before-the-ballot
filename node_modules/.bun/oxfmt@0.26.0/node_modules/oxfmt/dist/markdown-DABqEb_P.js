//#region ../../node_modules/.pnpm/prettier@3.8.0/node_modules/prettier/plugins/markdown.mjs
...
var cn = x((sn) => {
	...
	sn.openCloseTag = /* @__PURE__ */ new RegExp("^(?:" + so + "|" + co + ")");
	sn.tag = /* @__PURE__ */ new RegExp("^(?:" + so + "|" + co + "|" + zh + "|" + Wh + "|" + Vh + "|" + jh + ")");
});
var po = x((Yv, Do) => {
	"use strict";
