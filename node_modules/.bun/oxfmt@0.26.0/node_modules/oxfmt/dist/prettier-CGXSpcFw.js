...
//#endregion
//#region ../../node_modules/.pnpm/prettier@3.8.0/node_modules/prettier/doc.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/prettier@3.8.0/node_modules/prettier/index.mjs
...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-Cv_-UuqV.js"));
	try {
...
var estreePlugin = createParsersAndPrinters([{
	importPlugin: () => import("./estree-De2vQ5tK.js"),
...
var { parsers, printers } = createParsersAndPrinters([
	{
		importPlugin: () => import("./acorn-Brmq34Aq.js"),
		parsers: ["acorn", "espree"]
	},
	{
		importPlugin: () => import("./angular-Dka1HNDm.js"),
		parsers: [
			"__ng_action",
			"__ng_binding",
			"__ng_interpolation",
	...
	{
		importPlugin: () => import("./babel-nZcctAia.js"),
		parsers: [
			"babel",
			"babel-flow",
			"babel-ts",
	...
	{
		importPlugin: () => import("./flow-BYCXmncj.js"),
		parsers: ["flow"]
	},
	{
		importPlugin: () => import("./glimmer-Bd1WF-Jp.js"),
		parsers: ["glimmer"],
		printers: ["glimmer"]
	},
	{
		importPlugin: () => import("./graphql-BHIFTFgx.js"),
		parsers: ["graphql"],
		printers: ["graphql"]
	},
	{
		importPlugin: () => import("./html-izYVfIHI.js"),
		parsers: [
			"html",
			"angular",
			"vue",
	...
	{
		importPlugin: () => import("./markdown-DABqEb_P.js"),
		parsers: [
			"markdown",
			"mdx",
			"remark"
	...
	{
		importPlugin: () => import("./meriyah-C5Ztw13E.js"),
		parsers: ["meriyah"]
	},
	{
		importPlugin: () => import("./postcss-DvcG8_nz.js"),
		parsers: [
			"css",
			"less",
			"scss"
	...
	{
		importPlugin: () => import("./typescript-HZ8R57sp.js"),
		parsers: ["typescript"]
	},
	{
		importPlugin: () => import("./yaml-Cv_-UuqV.js"),
		parsers: ["yaml"],
		printers: ["yaml"]
	}
]);
